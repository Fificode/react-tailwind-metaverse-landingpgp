...
const Feature = () => {
  return (
      <div className="flex flex-row justify-center items-center mt-[60px] xl:mt-[40px]">
    <div className='bg-light-purple flex flex-col items-center w-[100%] h-[100%]  xl:flex xl:flex-row xl:justify-between xl:w-[100%] xl:h-[240px]'>
